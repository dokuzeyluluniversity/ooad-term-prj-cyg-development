...
public class Computer extends Electronics {
  ...
  public Computer(String brand, String name, double price, int itemID, Manufacturer manufacturer, double size,
                  String resolution, String processor, String graphicsCard, String graphicsCapacity, String ramType,
                  String ramSpeed, String ramCapacity, String storage) {
